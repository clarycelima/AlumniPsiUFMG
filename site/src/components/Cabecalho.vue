...
export default {
  ...
  props: {
    ...
    descricaoPrimaria: { type: String },
    descricaoSecundaria: { type: String },
    conheca: { type: Boolean, default: false }
  }
};
</script>
...
.jumbotron{
    padding: 1rem 2rem;
    border-radius: 0;
    background: darken($primary, 3);// url('../assets/network.png') center top no-repeat;
