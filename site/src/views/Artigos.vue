    ...
    <div>
        ...
        <div class="container-fluid mb-4">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Atuação profissional dos egressos.pdf">
                Atuação profissional dos egressos
                </a></li>
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Bacharel e docencia.pdf">
                Bacharel e docencia
                </a></li>
                ...
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Construção da carreira egressos psicologia Tese.pdf">
                Construção da carreira egressos psicologia Tese
                </a></li>
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Construção de conhecimento.pdf">
                ...
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Formaçao de doutores.pdf">
                ...
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Lacunas de competencias egressos psicologia.pdf">
                ...
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Perspectivas de egressos avaliação.pdf">
                Perspectivas de egressos avaliação
                </a></li>
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Planejamento para acompanhamento egressos.pdf">
                Planejamento para acompanhamento egressos
                </a></li>
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Produçao cientifica psicologia graduaçao.pdf">
                Produçao cientifica psicologia graduaçao
                </a></li>
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Redes coautoria posgrado UFRGS.pdf">
                Redes coautoria posgrado UFRGS
                </a></li>
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Sistema de Mapeamento de Egressos Proposta Medicina III.pdf">
                Sistema de Mapeamento de Egressos Proposta Medicina III
                </a></li>
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Sistema de mapeamento de egressos.pdf">
                Sistema de mapeamento de egressos
                </a></li>
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Teses e Dissetações Egressos 03-2017.pdf">
                ...
                <li class="list-group-item"><a target="blank" href="/AlumniPsiUFMG/artigos/EGRESSOS/Transnacionalização ensino psicologia.pdf">
